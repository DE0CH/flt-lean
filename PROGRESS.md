...
**Sorried declarations (compiler-counted): 86** — `mem_range_pullback_of_translation_lift_fixed`, `spanSingleton_pointEval_mul_fiberProd_pow`, `fiberProd_prod_inj`, `span_vertNumerator`, `span_lineNumerator`, `exists_multiset_span_eq_prod_pointIdeal`, `translationChar_setup_value`, `exists_weilValueSetup_avoiding`, `exists_torsionKernel_tangent_killer`, `exists_torsionKernel_hazard_killer`, `exists_torsionKernel_mixed_killer`, `exists_torsionKernel_formal_killer`, `exists_fixedPointHopfOrder_of_algebraOrder`, `not_two_torsion_and_five_point`, `exists_localTorsionQuotient_of_good_ordinary`, `exists_quotient_isogeny_of_odd_prime_card`, `not_local_inertia_eigenvector_of_good_of_supersingular`, `no_composite_torsion_order`, `not_two_four_torsion_and_three_point`, `no_prime_torsion_ge_eleven`, `exists_quotient_isogeny_of_rational_two_torsion`, `exists_muType_coordinate`, `archimedeanGammaProfile_exists`, `two_mul_local_differentIdeal_exponent_add_two_le_of_herbrand_bound`, `xi_logDeriv_gap_bound`, `ramificationIdx'_comap_maximalIdeal_eq_local`, `character_globalFrob_sq_eq_one_of_narrow_exponent_two_ray_class`, `poitouPhi_strip_decay_sq`, `heckeThetaSeries_functionalEquation`, `two_mul_sum_card_inertia_le_card_inertia_of_hopf_package`, `maximalIdeal_pow_dvd_local_differentIdeal_of_comap_pow_dvd`, `heckeThetaSeries_analysis`, `dedekindZeta_logDeriv_eq_neg_tsum`, `exists_conj_image_localInertiaGroup_rat_ray_class`, `inertiaFixed_connected_point_eq_one_at_three`, `trivial_component_vanishes_of_hopf_package`, `omega_defect_vanishes_of_hopf_package`, `exists_minimal_mvPowerSeries_presentation`, `exists_isTraceGenerated_ringHom`, `exists_relations_lt_of_minimal_mvPowerSeries_presentation`, `exists_isWeaklyUniversalOnIdentified`, `finite_quotient_span_of_isWeaklyUniversal_isTraceGenerated`, `threeadicRealization_isFlat_of_witness`, `exists_heckePackage_of_seed`, `exists_threeadicRealization_of_witness`, `exists_threeadic_realization_of_heckePackage`, `threeadicRealization_det_cyclotomic_of_witness`, `exists_moretBailly_seed_of_five_le`, `threeadicRealization_isUnramified_of_witness`, `brauer_induction_trivial_character`, `exists_heckeField_system_of_witness_of_pieces`, `threeadicRealization_isTameAtTwo_of_witness`, `exists_descended_heckeSystem_of_solvable`, `exists_isRegular_ofList_eq_maximalIdeal_mvPowerSeries`, `isNoetherianRing_mvPowerSeries`, `exists_patchedModule`, `isWeaklyUniversalOnIdentifiedDeformation_of_finiteTests`, `exists_weaklyUniversalOnIdentified_framed_finiteTests`, `exists_discr_factorization_le_of_finrank_le`, `exists_taylorWilesTower`, `eisenstein_trivial_sub_extension_cc_eq_zero_on_inertia_two_of_five_le`, `nonempty_modularHomologyPackage`, `herbrand_omega_inv_classGroup_eigenspace_trivial_of_five_le`, `character_eq_pow_cyclotomicCharacter_of_unramified_outside_p`, `exists_ribet_walk_stable_line`, `exists_inertia_connectedEtale_complement_of_isFlatAt`, `exists_weightTwoEigenform_not_four_dvd_level_of_inertia_fixed_line`, `weightTwoNewform_not_dvd_level_of_isUnramifiedAt_of_isIrreducible`, `hasFlatProlongationAt_lattice_pPow_of_generic_iso`, `not_isIrreducible_of_charpoly_coeff_one_eq_sum_monoidHom`, `algebraMap_cyclotomicCharacter_eq_one_of_mem_localInertiaGroup_two`, `algebraMap_cyclotomicCharacter_map_adicArithFrob_two_eq_two`, `exists_uniform_conj_decomposition_two_padic`, `exists_cyclotomicCharacter_residual_ne_one`, `exists_conjugator_padicGalois_eq_adic_at_p`, `of_injective`, `prod`, `mem_of_isOpen_of_localInertiaGroup_le_of_adicArithFrob_mem_two`, `of_surjective`, `exists_integral_qExpansion_spanning`, `exists_weightTwoEigenform_not_dvd_level_p_of_isFlatAt_of_isIrreducible`, `eisenstein_trivial_sub_extension_ker_vanishing_of_eigenspace_trivial`, `exists_valuationRing_stable_lattice`, `isFlatAt_cycDiagRep`, `connected_point_smul_eq_conv_pow_cyclotomicCharacter_of_hopf_package`, `cyclotomicCharacter_eq_one_of_mem_localInertiaGroup_of_ne`
                                                            ...
                                                            - ✅· `exists_line_with_quotCharacter_eq_subCharacter`
                                                                - ✅· `exists_splitting_scalar_of_quot_ramified`
                                                                    - ✅· `exists_inertia_eigenvector_complement_at_three`
                                                                        - ❌🟪 `inertiaFixed_connected_point_eq_one_at_three`
                                                    - ✅· `GaloisRepresentation.IsHardlyRamified.mod_three_reducible`
                                                        - ✅· `not_isAbsolutelyIrreducible`
                                                            - ✅· `serre_elimination`
                                                                - ✅· `serre_elimination_noncyclic`
