                            ...
                            - ✅· `WeierstrassCurve.exists_tateEquivSepClosure` — Tate's uniformisation over a separable closure, now DERIVED from the
                              ...
                              transports through the composite.
                                ...
                                - ❌· `WeierstrassCurve.exists_tateCurveEquivSepClosure` — the choice-free core of Tate's uniformisation: `E_q(Ω) ≅ Ωˣ/q^ℤ`
                                  ...
                                  `TateCurveConstruction`); glued over the finite subextensions of
                                  `Ω`.
                            - ❌· `inertia_fixes_algHom_of_unramified_gen_padic_two` — the Z2bar-spelling of inertia-fixes-unramified-embeddings: every mod-𝔪
                              inertia element of the spectral-norm valuation subring of ℚ_[2]ᵃˡᵍ
                              fixes each embedding of an extension generated by a monic-integral-
                              lift root with separable residue reduction; the ℚ_[2]-analogue of the
                              proven adicCompletion version.
