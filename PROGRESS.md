...
_Generated from `471b49b` (2026-07-25T23:51:48+01:00) — Merge branch 'staging' into flt-lean-87._

_The worktree was DIRTY when this ran: uncommitted edits are not described by the commit named above._

**Sorried declarations (compiler-counted): 103** — `velu_map_add`, `velu_equation`, `velu_isElliptic`, `count_pointEval_YClass_of_smul_ne_zero`, `count_pointEval_XClass_of_smul_ne_zero`, `millerValue_crossRatio_pow_mul_translationChar`, `exists_torsionPairFormalNumerators`, `localReduction_inertia_invariant_of_good_reduction`, `no_torsion_order_21`, `tateNormalForm_origin_order_ne_13`, `not_cyclicIsogeny_oneHundredTwentyFive`, `no_rational_two_torsion_abscissa`, `tateNormalForm_origin_order_ne_11`, `not_order_two_and_order_seven_point`, `tateNormalForm_origin_order_ne_37`, `localReduction_surjective_of_good_reduction`, `tateNormalForm_origin_order_ne_43`, `spectralNorm_torsion_abscissa_of_good_of_supersingular`, `not_cyclicIsogeny_sq_of_prime_ge_seven`, `exists_tate_disc_of_order_five`, `tateNormalForm_origin_order_ne_163`, `exists_zsmul_eq_of_mem_torsionBy_of_charP`, `not_cyclicIsogeny_thirtyTwo`, `not_order_three_and_order_five_point`, `notPrimePow_mem_cyclicIsogenyDegrees`, `tateNormalForm_origin_order_ne_19`, `quartic_no_solution`, `no_torsion_order_25`, `quartic_only_trivial`, `not_isogenyCharacter_of_prime_ge_twentyThree`, `exists_localInertia_tameCharacter_orbit`, `no_torsion_order_27_of_j`, `exists_localReductionDatum_of_good_reduction`, `tateNormalForm_origin_order_ne_67`, `not_cyclicIsogeny_eightyOne`, `tateNormalForm_origin_order_ne_17`, `j_of_stable_cyclic_subgroup_order_27`, `displacement_span_le_span_zeta_sub_one`, `le_sum_card_inertia_sub_one_of_pow_dvd_local_differentIdeal`, `pow_card_inertia_inf_mul_add_sum_dvd_local_differentIdeal`, `archConv_integrableOn`, `archConv_continuousOn`, `convCube_id_eq_one_of_hopf_package`, `kaehlerDifferential_nsmul_eq_zero_of_nsmul_mem_sq_ker_counit`, `heckeIdealTheta_functionalEquation`, `exists_artinSymbol_isNarrowPrincipal_ray_class`, `sub_mem_span_three_mul_maximalIdeal_of_lt_two_mul_sum_card_inertia`, `invariant_functional_defect_vanishes_of_hopf_package`, `omega_defect_coboundary_of_hopf_package`, `frameLevels_directed`, `hasFlatProlongationAt_of_pi_surjection`, `exists_relations_le_smul_of_minimal_mvPowerSeries_presentation`, `exists_framedGaloisRep_baseChange_traceSubring`, `exists_universalFrame_profinite_of_levelIdealSystem`, `finite_setOf_isHardlyRamified_frames`, `exists_cyclotomicCharacter_padicTwo_eq_two`, `frameLevels_nonempty`, `hasFlatProlongationAt_of_prod_injection`, `exists_noetherianLocal_surjective_quotient_traceSubring`, `exists_finiteIndex_isIntegral_charpolyCoeff_quotient_minimalPrime_of_isWeaklyUniversal_isTraceGenerated`, `frameLevels_classification`, `threeadicRealization_hasFlatProlongationAt_threePow`, `exists_degreeOnePlace_of_brauer`, `blggt_threeadicBrauerSum_of_witness`, `nonempty_hilbertBlumenthalPoint_of_isTwistedHilbertBlumenthalModuli`, `exists_twistedHilbertBlumenthalModuliScheme_of_five_le`, `exists_residualModularity_of_hilbertBlumenthalPoint`, `exists_totallyReal_point_of_geometricallyIrreducible`, `hasFlatProlongationAt_of_surjective`, `threeadicRealization_ramified_transfer_of_witness`, `cyclotomicCharacter_adicArithFrob_base_eq_absNorm`, `exists_heckeField_mem_range_of_eigensystem`, `exists_heckeSystem_of_residualModularity`, `carayol_threeadic_realization_of_heckePackage`, `heckeSystemDescendsTo_of_prime_cyclic_step`, `threeadicRealization_stableLineAtTwo_of_witness`, `exists_framedStrictlyUniversal_hardlyRamified_finiteTests`, `free_quotientAnnihilator_of_linearEquiv_piQuotient`, `finite_quotient_maximalIdeal_pow_mvPowerSeries`, `exists_taylorWilesLevelRaw`, `topologicallyFG_int_mvPowerSeries`, `exists_discr_factorization_le_of_finrank_le`, `exists_taylorWilesBottomLevel`, `exists_ringHom_quotient_padicTower_of_finiteTests`, `ker_constantCoeff_mvPowerSeries`, `uniformlyBoundedRank_of_linearEquiv_piQuotient`, `subsingleton_ringHom_padicInt`, `exists_stable_line_of_ribet_walk_split`, `exists_qExpansion_denominator`, `exists_heckeOp_newform_etaleIdempotent`, `exists_rational_qExpansion_spanning`, `hasConductorExponentAt_two_le_one_of_inertia_sq_eq_zero`, `hasConductorExponentAt_factorization_of_isNewAtPrime`, `exists_pow_sub_one_mul_pro_p_of_cyclotomicCharacter_toZModPow_eq_one`, `hilbertClassField_ker_vanishing_of_classGroup_twisted_hom_vanishing`, `exists_ribet_walk_swap_order`, `exists_frobenius_conj_localInertia_eq_pow_p_mul_pro_p`, `not_isFlatAt_of_weightTwoEigenform_pNew_of_isIrreducible_of_pNeZero`, `nonempty_modularHeckeComparisonPackage`, `stickelberger_prod_map_prime_ideal_isPrincipal`, `exists_flatIsogenousLattice_of_generic_iso`, `exists_grouplike_family_of_connected_hopf_package`, `isFlatAt_cycDiagRep`
        ...
        - ✅· `FreyPackage.mazur`
                                        ...
                                        - ✅· `exists_etale_line_of_good_of_stable_line`
                                            - ✅· `exists_etale_line_or_no_stable_line_of_good`
                                                - ✅· `exists_etale_line_of_good_of_inertia_stable_line`
                                                    - ❌🟪 `exists_localTorsionQuotient_of_good_ordinary`
                                                    - ❌🟪 `not_local_inertia_eigenvector_of_good_of_supersingular`
            ...
            - ✅· `WeierstrassCurve.mazur_torsion_bound`
                - ✅· `WeierstrassCurve.mazur_classification`
                    ...
                    - ✅· `not_two_ten_torsion`
                        - ❌🟪 `not_two_torsion_and_five_point`
                    - ✅· `not_two_twelve_torsion`
                        - ❌🟪 `not_two_four_torsion_and_three_point`
        - ✅· `FreyPackage.galoisRep_not_irreducible`
            - ✅· `FreyCurve.torsion_isHardlyRamified`
                - ✅· `FreyCurve.torsion_det`
                                                        ...
                                                        - ✅· `exists_equivariant_defect_coboundary`
                                                            - ✅· `exists_omega_cocycle_coboundary`
                                                                - ✅· `omega_defect_vanishes_on_cyclotomicKernel`
                                                                    - ❌🟪 `omega_defect_vanishes_of_hopf_package`
