                                                                    ...
                                                                    - ✅· `TateCurve.bilateral_add_of_X_ne` — the chord identity (V.3.1(c)
                                                                      ...
                                                                      cleared forms.
                                                                            ...
                                                                            - ✅· `TateCurve.bilateral_chordY_cleared_window` — window case of the cleared
                                                                              ...
                                                                              evalA_chordY).
                                                                                - ✅· `TateCurve.evalA_chordY` — evalA-level chord Y-identity
                                                                                  (DERIVED 2026-07-18: same via
                                                                                  chordY_formal and its
                                                                                  transport).
                                                                                    - ❌· `TateCurve.chordY_formal` — formal chord Y-identity in
                                                                        ...
                                                                        - ✅· `TateCurve.bilateral_chordX_cleared` — cleared chord X-identity
                                                                          ...
                                                                          in the fundamental annulus,
                                                                          val q₀ < val(u₀v₀), delegating
                                                                          to the window and shifted
                                                                          leaves). Statement
                                                                          strengthened with hu1 : u₀ ≠
                                                                          1, hv1 : v₀ ≠ 1 (available at
                                                                            ...
                                                                            - ✅· `TateCurve.bilateral_chordX_cleared_window` — window case of the cleared
                                                                              ...
                                                                              delegating to evalA_chordX).
                                                                                - ✅· `TateCurve.evalA_chordX` — evalA-level chord X-identity
                                                                                  (DERIVED 2026-07-18: applies
                                                                                  the two-variable evaluation
                                                                                  transport to the formal
                                                                                  identity chordX_formal).
                                                                                    - ❌· `TateCurve.chordX_formal` — formal chord X-identity in
                                                                                      CoeffRing₂⟦q⟧ (sorry node):
                                                                                      CoeffRing₂ = ℚ[u,v] localized
                                                                                      away from u(1-u)v(1-v)(1-uv),
                                                                                      slot maps uSlot/vSlot/uvSlot :
                                                                                      CoeffRing → CoeffRing₂ built
                                                                                      (Localization.awayLift over
                                                                                      eval₂RingHom substitutions;
                                                                                      denominator factors proven
                                                                                      units). To resolve: inject
                                                                                      CoeffRing₂ into ℚ(u)(v) =
                                                                                      RatFunc (RatFunc ℚ) (mirror
                                                                                      coeffRingToRatFunc_injective),
                                                                                      pull the identity back from
                                                                                      the ℚ(u)(v)⟦q⟧ identity, which
                                                                                      descends from analytic_chordX
                                                                                      (PROVEN,
                                                                                      TateCurveConstruction) — full
                                                                                      descent design: Formal layer
                                                                                      (to be built AS CONSUMED, top-
                                                                                      down): three substitution homs
                                                                                      ℚ(u) →+* ℚ(u)(v) (C-embedding;
                                                                                      u↦v and u↦uv via substHom :=
                                                    ...
                                                    - ✅· `TateCurve.pointMapQuot_add` — the addition law (Silverman ATAEC V.3.1(c)).
                                                      ...
                                                      classes).
                                                        ...
                                                        - ✅· `TateCurve.bilateral_add_of_X_ne` — the chord identity (V.3.1(c) generic
                                                          ...
                                                          forms.
                                                            - ✅· `TateCurve.bilateral_chordY_cleared` — cleared chord Y-identity (DERIVED
                                                            ...
                                                            - ✅· `TateCurve.bilateral_chordX_cleared` — cleared chord X-identity (DERIVED
                                                              ...
                                                              val q₀ < val(u₀v₀), delegating to the
                                                              window and shifted leaves). Statement
                                                              strengthened with hu1 : u₀ ≠ 1, hv1 :
                                                            ...
                                                            - ✅· `TateCurve.bilateral_add_of_X_ne` — the chord identity (V.3.1(c) generic
                                                              ...
                                                              against the cleared forms.
                                                                ...
                                                                - ✅· `TateCurve.bilateral_chordX_cleared` — cleared chord X-identity (DERIVED
                                                                  ...
                                                                  fundamental annulus, val q₀ <
                                                                  val(u₀v₀), delegating to the
                                                                  window and shifted leaves).
                                                                  Statement strengthened with hu1 :
                                                                  u₀ ≠ 1, hv1 : v₀ ≠ 1 (available at
                                                                  the pointMap_mul call site),
                                                ...
                                                - ✅· `TateCurve.bilateral_add_of_X_ne` — the chord identity (V.3.1(c) generic case).
                                                  ...
                                                  + linear_combination against the cleared forms.
                                                    - ✅· `TateCurve.bilateral_chordY_cleared` — cleared chord Y-identity (DERIVED 2026-07-18:
                                                      ...
                                                      statement strengthened with hu1/hv1).
                                                        - ✅· `TateCurve.bilateral_chordY_cleared_window` — window case of the cleared chord
                                                          ...
                                                          evalA_chordY).
                                                            - ✅· `TateCurve.evalA_chordY` — evalA-level chord Y-identity (DERIVED
                                                              2026-07-18: same via chordY_formal and
                                                              its transport).
                                                                - ❌· `TateCurve.chordY_formal` — formal chord Y-identity in
                                                    ...
                                                    - ✅· `TateCurve.bilateral_chordX_cleared` — cleared chord X-identity (DERIVED 2026-07-18:
                                                      ...
                                                      delegating to the window and shifted leaves).
                                                      Statement strengthened with hu1 : u₀ ≠ 1, hv1
                                                      ...
                                                      pole at u = 1).
                                                        - ✅· `TateCurve.bilateral_chordX_cleared_window` — window case of the cleared chord
                                                          ...
                                                          evalA_chordX).
                                                            - ✅· `TateCurve.evalA_chordX` — evalA-level chord X-identity (DERIVED
                                                              2026-07-18: applies the two-variable
                                                              evaluation transport to the formal
                                                              identity chordX_formal).
                                                                - ❌· `TateCurve.chordX_formal` — formal chord X-identity in
                                                                  CoeffRing₂⟦q⟧ (sorry node):
                                                                  CoeffRing₂ = ℚ[u,v] localized away
                                                                  from u(1-u)v(1-v)(1-uv), slot maps
                                                                  uSlot/vSlot/uvSlot : CoeffRing →
                                                                  CoeffRing₂ built
                                                                  (Localization.awayLift over
                                                                  eval₂RingHom substitutions;
                                                                  denominator factors proven units).
                                                                  To resolve: inject CoeffRing₂ into
                                                                  ℚ(u)(v) = RatFunc (RatFunc ℚ)
                                                                  (mirror
                                                                  coeffRingToRatFunc_injective),
                                                                  pull the identity back from the
                                                                  ℚ(u)(v)⟦q⟧ identity, which
                                                                  descends from analytic_chordX
                                                                  (PROVEN, TateCurveConstruction) —
                                                                  full descent design: Formal layer
                                                                  (to be built AS CONSUMED, top-
                                                                  down): three substitution homs
                                                                  ℚ(u) →+* ℚ(u)(v) (C-embedding; u↦v
                                                                  and u↦uv via substHom := coercion
                                                                  of
