...
`Isogeny.isRationalMap_dualHom`. That ONE is the whole remaining frontier of this
module; the list is stated from the file's actual sorry set at 2026-07-27, not
inherited from either side of a merge.
