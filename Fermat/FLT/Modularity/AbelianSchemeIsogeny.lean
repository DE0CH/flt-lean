...
-- composition of `irreducibleSpace_of_connectedSpace_of_locallyIrreducible` and
-- `exists_isOpen_isIrreducible_of_isDomain_stalk`, which live in the shim tree
...
public import Fermat.FLT.Mathlib.AlgebraicGeometry.LocallyIrreducible
...
`Fermat/FLT/Mathlib/AlgebraicGeometry/LocallyIrreducible.lean`, which every one
...
-- `irreducibleSpace_of_connectedSpace_of_locallyIrreducible` and
-- `exists_isOpen_isIrreducible_of_isDomain_stalk`
-- (`Fermat/FLT/Mathlib/AlgebraicGeometry/LocallyIrreducible.lean`), which prove
...
shim module `Fermat/FLT/Mathlib/AlgebraicGeometry/LocallyIrreducible.lean` —
...
**THE PROOF.**  `exists_isOpen_isIrreducible_of_isDomain_stalk` gives every
...
`irreducibleSpace_of_connectedSpace_of_locallyIrreducible` upgrades that to
...
theorem irreducibleSpace_of_connected_of_isDomain_stalk (X : Scheme.{u}) [IsLocallyNoetherian X]
    ...
    IrreducibleSpace X :=
  _root_.GaloisRepresentation.Modularity.irreducibleSpace_of_connectedSpace_of_locallyIrreducible
    (fun x => _root_.GaloisRepresentation.Modularity.exists_isOpen_isIrreducible_of_isDomain_stalk
      x (hdom x))
