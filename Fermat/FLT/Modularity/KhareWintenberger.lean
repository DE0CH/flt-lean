...
(SORRY -- Taylor S4, the moduli construction) and
...
theorem nonempty_hilbertBlumenthalPoint_of_isTwistedHilbertBlumenthalModuli
  ...
  obtain ⟨ϖℓ, hϖℓ, hϖℓ2, O₀, _, _, _, _, _, _, _, _, σ, φ₀, ι₀, baddet,
      hφ₀add, hφ₀bij, hφ₀eq, hres₀, hdet₀⟩ :=
  ...
  obtain ⟨ϖp, hϖp, hϖp2, C, _, _, _, _, _, _, _, _, τp, φp, ιp, _,
      hφpadd, hφpbij, hφpeq, hresp, _⟩ :=
