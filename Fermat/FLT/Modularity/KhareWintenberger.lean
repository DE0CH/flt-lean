...
"smooth over a field implies reduced". Item 3 itself now splits into three
mutually independent starting points — the smoothness leaf, the connectedness
leaf and the formal upgrade — see item 3 above for their names.
