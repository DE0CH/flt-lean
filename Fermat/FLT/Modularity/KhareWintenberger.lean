...
a PROVEN assembly over the six declarations of this section — TWO of which
are open leaves as of 2026-07-28, namely STEP 1a-i (the class-field-theoretic
core) and STEP 1a-vi (adelic patching). The four ordinary-algebra bricks —
STEP 1a-ii `isQuaternionAlgebra_quaternionAlgebra_of_ne_zero`, STEP 1a-iii
`nonempty_algEquiv_quaternionAlgebra_baseChange`, STEP 1a-iv
`nonempty_algEquiv_quaternion_of_neg` and STEP 1a-v
`isUnit_of_ne_zero_quaternionAlgebra_of_neg_embedding` — are all PROVEN
