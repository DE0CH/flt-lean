/-
Modularity/PatchingVendored/Lemmas.lean — VENDORED from the FLT project (ImperialCollegeLondon/FLT),
`FLT/Patching/Utils/Lemmas.lean`, at commit e00fe1c4 (mathlib pin 81a5d25), adapted to this
...
def TwoSidedIdeal.leAddSubgroup {α} [NonUnitalNonAssocRing α] (G : AddSubgroup α) :
  ...
  .mk'
    ...
    (by change (span {(0 : α)} : Set α) ⊆ G; simp)
    (fun {x y} hx hy ↦ by
