...
`locallyStandardSmooth_of_gamma1GITPresentation` and (since 2026-07-28,
replacing `connectedSpace_tensorProduct_of_gamma1GITPresentation`, which is
now PROVEN over it)
`isDomain_fractionRing_tensorProduct_of_gamma1GITPresentation` — a
