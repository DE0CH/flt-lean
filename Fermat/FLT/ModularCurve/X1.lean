...
needs `Frac B / K` separably generated — which is half 2 of the route on
`isDomain_fractionRing_tensorProduct_of_gamma1GITPresentation`, i.e. a
sibling leaf, not a free step.
