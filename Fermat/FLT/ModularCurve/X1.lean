...
Riemann–Roch, isolated in `exists_weierstrassRingEquiv_of_abelianSchemeChart`
immediately above.  The three conjuncts of the conclusion are discharged as
