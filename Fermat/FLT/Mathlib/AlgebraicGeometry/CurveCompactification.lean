...
at the end of this file; see the note there).  **NO LONGER A LEAF: PROVEN 2026-07-27** in
`CurveExtension.lean`, over Krull's height theorem and the Nullstellensatz; do not dispatch at it.
