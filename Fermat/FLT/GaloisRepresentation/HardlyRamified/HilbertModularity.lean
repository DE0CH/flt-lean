...
3. `HilbertDeformationDatum` / `IsWeaklyUniversal` — Mazur's category and
   ...
   Of those four clauses, `isHilbertFiniteFramesClause` (Schlessinger's
   H3) is no longer a leaf: it was DECOMPOSED 2026-07-26 along the
   Hermite–Minkowski cut and is now PROVEN over the two bookkeeping
   lemmas `finite_setOf_framedGaloisRep_isUnramifiedAt` and
