...
- [A refuted bound route still closes most levels](flt-a-false-bound-route-still-closes-most-levels.md) — "the tail<head shape is FALSE here" was true of the leaf and false of 15 of its 32 levels; measure per level before abandoning, and the sibling's threshold is not yours
