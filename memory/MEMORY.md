...
- [Image-for-quotient has three tests](flt-image-for-quotient-has-two-tests.md) — dimension / direction / an-ambient-must-exist; the X0 sweep of 13 leaves found NO further instance, and a docstring's own refuting grep is usually scoped too narrowly
