...
- [Reduce to an open LEAF, not to a proof](flt-reduce-to-an-open-leaf-not-a-proof.md) — an absence audit asks "is it proven" and misses a sorry leaf stating the same theorem; merging two theory gates is progress even at leaf-count zero, and declaration ORDER decides the cost
