...
- ["mathlib lacks X" is about X](audit-lacks-x-is-about-x.md) — three audits costed the g¹₂'s finiteness clause at Riemann–Roch; the pin HAS Zariski's Main Theorem and no degree is used — grep MorphismProperty inf-decompositions, not the mathematical noun
