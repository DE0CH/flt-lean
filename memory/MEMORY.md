...
- [A relative theory may be definitional](flt-relative-theory-may-be-definitional.md) — an audit's "needs a relative structure, not even statable" dies if the defining clause never mentions the base; composing the index deletes the transitivity theory
