...
- [AbelianSchemeStruct ↔ mathlib GrpObj bridge](flt-abelianscheme-grpobj-bridge.md) — build a group object + IsProper + GeometricallyIntegral and CONVERT; smoothness and commutativity of a group scheme over a field are already proven in `Mathlib/AlgebraicGeometry/Group/`
