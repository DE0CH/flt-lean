...
- [A fibre clause bounds the SEPARABLE degree](flt-fibre-clause-bounds-separable-degree.md) — "no fibre has 3 points" ≠ "deg ≤ 2" once the base is generalised off ℚ (t ↦ tᵖ); the statements survive, the proof routes and `Scheme.Hom.finrank` do not
