...
- [Eliminate the map to transport a proof](flt-eliminate-the-map-to-transport.md) — to re-run a domain proof over R/I, restate it about the ELEMENTS it consumes instead of building the induced morphism; IsReduced is usually the real hypothesis, and the residue belongs in the leaf's SIGNATURE
