...
- [A failing route is not a false leaf](flt-route-failing-is-not-leaf-false.md) — "the count no longer closes at p=3" is evidence about the ROUTE; refuting means EXHIBITING a counterexample, and the boundary case is usually the EASIEST (F=ℚ(ζ_p), h=1)
