...
- [A uniqueness blocker may be avoidable](flt-uniqueness-may-be-avoidable.md) — apply the theorem that PRODUCES the object to the rival and compare the two in the ring; this deleted a Mazur-level "uniqueness of the order-p subgroup" obligation from the moduli↔Weierstrass bridge
