...
- [Absence audits grep the CONSUMER's vocabulary](flt-absence-audit-greps-consumer-vocabulary.md) — a "stated nowhere, not reachable by wiring" verdict missed three PROVEN halves named after their construction (`ratToGeom`), one of whose docstrings stated the equality verbatim; and a transitively-sorried theorem with no DIRECT sorry is a free citation
